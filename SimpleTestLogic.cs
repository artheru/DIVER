...
namespace DiverTest
{
    ...
    public class SimpleTestCart : LocalDebugDIVERVehicle
    {
    ...
    public class SimpleTestLogic : LadderLogic<SimpleTestCart>
    {
        ...
        public override void Operation(int iteration)
        {
            ...
            Console.WriteLine(
                $"Iteration {iteration}: result={cart.result}, computed={cart.computed:F2}"
            );
        }
    }
}
