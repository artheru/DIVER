...
export const CommunicationProfileObjects: ObjectDictionaryEntry[] = [
  { index: 0x1000, name: 'Device Type', dataType: 'U32', access: 'RO', description: 'Device type and Profile ID' },
  { index: 0x1001, name: 'Error Register', dataType: 'U8', access: 'RO', description: 'Error register' },
  { index: 0x1002, name: 'Manufacturer Status Register', dataType: 'U32', access: 'RO' },
  { index: 0x1003, name: 'Pre-defined Error Field', dataType: 'U32[]', access: 'RO', description: 'Pre-defined error history' },
  { index: 0x1005, name: 'COB-ID SYNC', dataType: 'U32', access: 'RW', description: 'SYNC message COB-ID' },
  { index: 0x1006, name: 'Communication Cycle Period', dataType: 'U32', access: 'RW', description: 'Communication cycle period (μs)' },
  { index: 0x1007, name: 'Synchronous Window Length', dataType: 'U32', access: 'RW', description: 'Synchronous window length (μs)' },
  { index: 0x1008, name: 'Manufacturer Device Name', dataType: 'STRING', access: 'RO', description: 'Device name' },
  { index: 0x1009, name: 'Manufacturer HW Version', dataType: 'STRING', access: 'RO', description: 'Hardware version' },
  { index: 0x100A, name: 'Manufacturer SW Version', dataType: 'STRING', access: 'RO', description: 'Software version' },
  { index: 0x100C, name: 'Guard Time', dataType: 'U16', access: 'RW', description: 'Node guarding time (ms)' },
  { index: 0x100D, name: 'Life Time Factor', dataType: 'U8', access: 'RW' },
  { index: 0x1010, name: 'Store Parameters', dataType: 'U32', access: 'RW', description: 'Store parameters (write 0x65766173="save")' },
  { index: 0x1011, name: 'Restore Default Parameters', dataType: 'U32', access: 'RW', description: 'Restore defaults (write 0x64616F6C="load")' },
  ...
  { index: 0x1015, name: 'Inhibit Time Emergency', dataType: 'U16', access: 'RW', description: 'Emergency inhibit time (100μs)' },
  { index: 0x1016, name: 'Consumer Heartbeat Time', dataType: 'U32[]', access: 'RW', description: 'Consumer heartbeat time' },
  { index: 0x1017, name: 'Producer Heartbeat Time', dataType: 'U16', access: 'RW', description: 'Producer heartbeat time (ms)' },
  // 0x1018 Identity Object
  { index: 0x1018, subIndex: 0, name: 'Identity Object - Number of Entries', dataType: 'U8', access: 'RO' },
  { index: 0x1018, subIndex: 1, name: 'Vendor ID', dataType: 'U32', access: 'RO', description: 'Vendor ID' },
  { index: 0x1018, subIndex: 2, name: 'Product Code', dataType: 'U32', access: 'RO', description: 'Product code' },
  { index: 0x1018, subIndex: 3, name: 'Revision Number', dataType: 'U32', access: 'RO', description: 'Revision number' },
  { index: 0x1018, subIndex: 4, name: 'Serial Number', dataType: 'U32', access: 'RO', description: 'Serial number' },
